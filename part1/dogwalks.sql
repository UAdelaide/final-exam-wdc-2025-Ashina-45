...
-- Insert Dogs (using subqueries to get owner_ids)
...
-- Insert Walk Requests (using subqueries to get dog_ids)
...
VALUES
    ...
    ((SELECT dog_id FROM Dogs WHERE name = 'Rocky' AND owner_id = (SELECT user_id FROM Users WHERE username = 'emma_pet')),
